...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dicomTags_lable.setGeometry(QRect(800, 140, 61, 16))
        ...
        self.treeWidget.setGeometry(QRect(400, 160, 391, 321))
        self.treeWidget.setContextMenuPolicy(Qt.ActionsContextMenu)
        self.tableWidget = QTableWidget(self.centralwidget)
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.setGeometry(QRect(800, 160, 241, 321))
        font = QFont()
        font.setPointSize(7)
